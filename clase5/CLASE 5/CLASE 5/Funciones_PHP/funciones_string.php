...
<html>
  ...
  <body>
    <div>
      ...
      if (!strstr($Email, '@')) {  //no existe el @ en esta cadena??? 
      ...
      <h3>Reemplazo de palabras: busca dentro de una cadena y reemplaza con una palabra en específico</h3>
      <?php 
      $Frase = "Me encanta programar en Javascript";
      echo $Frase . '<br/>';
      echo "Frase modificada: <br/>";
      $Frase_Modificada = str_replace('Javascript', 'PHP', $Frase);
